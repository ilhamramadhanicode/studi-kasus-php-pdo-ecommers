...
<body>
    ...
    <form action="" method="post" class="w-25 m-auto mt-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <input type="text" name="category" class="form-control" autocomplete="off" placeholder="Kategori Menu" required>
        </div>
        <div class="mb-3">
            <input type="text" name="harga" class="form-control" autocomplete="off" placeholder="Harga Menu" required>
        </div>
        <div class="mb-3">
